...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright J.Bitzer, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/SomeMoreExperiments-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SomeMoreExperiments-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SomeMoreExperiments-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SomeMoreExperiments-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SomeMoreExperiments-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SomeMoreExperiments-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/SomeMoreExperiments-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/SomeMoreExperiments.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SomeMoreExperiments.iss",inplace=1):
